...
export default function GameNumberIndicator() {
  const { gameNumber, round } = useGameStateStore();
  ...
  return (
    ...
    >
      <motion.div
        initial={{ y: -50 }}
        animate={isGameNumberShow ? { y: -10 } : { y: -50 }}
    className="bg-gray-700 px-4 pt-3 rounded-b-lg w-[240px] h-[50px] flex items-center justify-center"
      >
