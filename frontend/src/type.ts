...
export type GameMessage = StartGameMessage  |PlayCardGameMessage | CallGameMessage | NextRoundRequestGameMessage | WaitGameMessage | NextGameRequestGameMessage
export type MessageEventPayload =
  | InitializeSlotMessage
  | UpdateUserListMessage
  | ChatMessage
  | AnnounceMessage | NameChangeMessage | GameMessage 
